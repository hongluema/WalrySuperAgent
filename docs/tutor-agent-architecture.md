...
- 摸底必须覆盖了解程度、学习动机、内容侧重，再按主题增加误区判断或现实约束
- 诊断题至少一道要求真实判断，不能全是自我评价题；每道题都说明答案将如何改变后续教学
...
诊断不是简单知识测验。每个主题都由课程设计器重新判断需要了解学生哪些方面，但至少要建立三类画像：真实起点、为什么学/准备拿来做什么、最希望深入哪部分。只有会改变讲解起点、案例选择、内容比重或练习方式的信息才值得提问。
